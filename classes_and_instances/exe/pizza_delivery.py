class PizzaDelivery:
    ...
    def make_order(self):
        ...
        current_ingr = ', '.join('{}: {}'.format(key, value) for key, value in self.ingredients.items())

        return f"You've ordered pizza {self.name} prepared with {current_ingr} and the price will be {self.price}lv."
